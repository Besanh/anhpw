                            ...
                            <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <input id="name_seo" type="text"
                                                        ...
                                                        name="name_seo" value="{{ old('name_seo') }}" required
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div>
                                                <input id="desinger" type="text"
                                                    ...
                                                    name="designer" value="{{ old('designer') }}" autocomplete="designer"
                                                    autofocus>
                                            ...
                                            <div>
                                                <input id="promote" type="text"
                                                    ...
                                                    name="promote" value="{{ old('promote') }}" required
                                ...
                                <div class="tab-pane fade" id="pills-content" role="tabpanel"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                <textarea id="benefit" class="form-control" name="benefit"></textarea>
                                            </div>
                                            @error('benefit')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div>
                                            <div class="form-group">
                                                <textarea id="ingredient" class="form-control" name="ingredient"></textarea>
                                            </div>
                                            @error('ingredient')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="tab-pane fade" id="pills-style" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    <textarea id="styles" class="form-control" name="styles"></textarea>
                                                </div>
                                                @error('styles')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
