                                ...
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        <input id="sap_id" type="text"
                                            ...
                                            value="{{ old('sap_id') }}" required autocomplete="sap_id" autofocus>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        <input id="capa" type="text"
                                            ...
                                            value="{{ old('capa') }}" required autocomplete="capa" autofocus>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        <input id="promote" type="text"
                                            ...
                                            value="{{ old('promote') }}" required autocomplete="promote" autofocus>
                                    ...
                                    <div>
                                        <input id="stock" type="text"
                                            ...
                                            value="{{ old('stock') }}" required autocomplete="price" autofocus>
