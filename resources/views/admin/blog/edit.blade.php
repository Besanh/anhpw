        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route($main_link . '.update', $blog->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        <input id="name" type="text"
                                            ...
                                            value="{{ old('title', $blog->title) }}" required autocomplete="name"
                                            autofocus>
                                    ...
                                    <div class="custom-file" data-toggle="tooltip" data-placement="top" title="400x300">
                                        ...
                                        <label class="custom-file-label" for="image">
                                            {{ $blog->image ? $blog->image : 'Choose file' }}
                                        </label>
                                    </div>
