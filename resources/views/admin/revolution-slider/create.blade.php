            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        {{ $title }}
                        <a href="{{ route($main_link . '.index') }}" class="float-right">Sliders</a>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ckfinder-input"
                                            value="{{ old('image') }}" name="image" placeholder="Upload file">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="priority" type="text"
                                        ...
                                        value="{{ old('priority') }}" autocomplete="priority" autofocus>
