                ...
                <ul class="list-inline g-pt-1 mb-0">
                    ...
                    <li class="list-inline-item g-pos-rel">
                        <a id="currency-dropdown-invoker-2"
                            ...
                            href="#" aria-controls="currency-dropdown-2" aria-haspopup="true"
                            aria-expanded="false" data-dropdown-event="hover"
                            data-dropdown-target="#currency-dropdown-2" data-dropdown-type="css-animation"
                    ...
                    <li class="list-inline-item g-pos-rel">
                        ...
                        <ul id="languages-dropdown-2"
                            ...
                            <li>
                                <a class="d-block g-color-black g-color-primary--hover g-text-underline--none--hover g-font-weight-400 g-py-5 g-px-20"
                                    href="#">
                                    <svg class="mr-1 g-ml-minus-10" xmlns="http://www.w3.org/2000/svg"
                                        height="11" width="27" viewBox="0 0 640 480">
                                        <defs>
                                            <clipPath id="a">
                                                <path fill-opacity=".67"
                ...
                <ul class="list-inline g-overflow-hidden g-pt-1 g-mx-minus-4 mb-0">
                    ...
                    <li class="list-inline-item">
                        <a id="account-dropdown-invoker-2"
                            class="g-color-white-opacity-0_6 g-color-primary--hover g-font-weight-400 g-text-underline--none--hover"
                            href="#" aria-controls="account-dropdown-2" aria-haspopup="true"
                            aria-expanded="false" data-dropdown-event="hover"
                            data-dropdown-target="#account-dropdown-2" data-dropdown-type="css-animation"
                            data-dropdown-duration="300" data-dropdown-hide-on-scroll="false"
                            data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                            Account
                        </a>
                ...
                <div class="d-inline-block g-valign-middle">
                    ...
                    <form id="searchform-1"
                        ...
                        <div class="input-group">
                            <input class="form-control g-font-size-13" type="search"
